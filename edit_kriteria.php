				...
				<div class="col-sm-6 offset-sm-3">
					...
					<div class="form-group">
						...
						<select name="target" id="target" class="form-control" required="true">
							<option value="1" <?php if ($target == "1"){ echo "selected"; } ?>>1</option>
							<option value="2" <?php if ($target == "2"){ echo "selected"; } ?>>2</option>
							<option value="3" <?php if ($target == "3"){ echo "selected"; } ?>>3</option>
							<option value="4" <?php if ($target == "4"){ echo "selected"; } ?>>4</option>
							<option value="5" <?php if ($target == "5"){ echo "selected"; } ?>>5</option>
							<option value="6" <?php if ($target == "6"){ echo "selected"; } ?>>6</option>
							<option value="7" <?php if ($target == "7"){ echo "selected"; } ?>>7</option>
						</select>
					</div>
					<div class="form-group">
						<label>Type</label>
