...
<div class="panel-heading"><strong>Aspek Kondisi Nutrisi Tanah</strong></div>
...
<tbody><tr>
<th>Nama Tanaman Pangan</th>
<th>Aspek Kandungan Nutrisi Tanag</th>
<th>Aspek Kondisi Lingkunga</th>
<th>Total</th>
<th>Rank</th>
</tr>
<tr>
...
<?php
                  ...
                  <tr>
                   ...
                   <td>
                    ...
                    <td>
                      <?php echo $terbobot_total[$row['id_pelamar']] = ($persen_1*(($core_persen_1*(($row1['bobot']+$row3['bobot'])/2)/100)+($secondary_persen_1*(($row2['bobot']+$row4['bobot'])/2)/100))/100)+($persen_2*(($core_persen_2*(($row5['bobot']+$row7['bobot'])/2)/100)+($secondary_persen_2*(($row6['bobot']+$row8['bobot'])/2)/100))/100)?>
                    </td>
                    <td class="text-primary">
