...
<html lang="en">
  <head>
    ...
    <title>SPK - Crop Recomendation using Profile Matching</title>
  ...
  ?>
    ...
    ?>
        ...
        <h1 class="h4 mb-3 font-weight-normal" >SPK - Crop Recomendation using Profile Matching</h1>
        ...
        <p class="mt-4 mb-3 text-muted">&copy; 2023. Magister Ilmu Komputer 2023</p>  
      </form>
  <?php
  }
  ?>
